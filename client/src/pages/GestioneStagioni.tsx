...
const GestioneStagioni: React.FC = () => {
    ...
    const generateWhatsAppRenewalMessage = (g: GiocatoreRinnovo, isRenewing: boolean) => {
...
ASD All Star Team`;
    ...
    const handleSendWhatsAppRenewal = (e: React.MouseEvent, g: GiocatoreRinnovo, isRenewing: boolean) => {
        e.stopPropagation();
        if (!g.telefono) {
